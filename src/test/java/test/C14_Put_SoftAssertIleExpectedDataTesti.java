...
public class C14_Put_SoftAssertIleExpectedDataTesti {
    ...
    @Test
    public void put() {
        // 1) URL hazırla ve reqBody olustur
        ...
        JSONObject reqBody = new JSONObject();  // Simdi DISARDAKIni olusturuyoruz.

        reqBody.put("status", "success");
        reqBody.put("data", data);

        // 2) Expected data olustur
        JSONObject expData = new JSONObject(); // Yukardaki reqBody ile hemen hemen ayni, o yuzden data'yi tekrar olusturmuyoruz.
                                                // Sadece eksik kismini ekliycez
